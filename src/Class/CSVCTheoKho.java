...
public class CSVCTheoKho {
    ...
    public CSVCTheoKho(String maTs, String tenTs, String tinhTrang, String nuocSx, String namSx, String donViTinh, String noiLuuTru, String thongSoKiThuat, int donGia, int soLuong) {
        this.maTs = maTs;
        this.tenTs = tenTs;
